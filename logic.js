...
function successHandle (data) {
    ...
    str_split.forEach(function(word) {
        word = word.replace("analysis", "analytics")
        word = word.replace("analyses", "analytics")
        word = word.replace("analytical", "analytics")
        word = word.replace("analyze", "analytics")
        word = word.replace("analyst", "analytics")
    ...
    var numberOfKeywords = parseInt(500)
    ...
    console.log(frequency_list.slice(0, 400))

    console.log(d3.max(frequency))
    console.log(d3.min(frequency))
